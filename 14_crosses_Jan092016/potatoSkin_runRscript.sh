...
#	cd ${folders[$i]}/cohort/$refFol
	cd ${folders[$i]}/$refFol
	Rscript ~/MyScripts/CompareVCF_Crosses/01_Jan092016/02_makeCSVTable_Fernando_readingF2s.R $output $(($i + 1))
#	Rscript ~/MyScripts/CompareVCF_Crosses/01_Jan092016/02_makeCSVTable_Fernando_readingF2s.R $output ${ids[$i]}
done

...
ids=(`echo "C6D6,C6KD,C6K7,C5E7,C6KY,C5M7,C6K6,C6K8,C6D5,C5M6,C5M8,C6KF,C6D4,C7V1,C7G5,C7G6,C896,C897,C898" | sed 's/,/\n/g'`)
#refFol="finalLikelihoodScore_swedes243"
refFol="finalLikelihoodScore_01.swedes220"
#refFol="finalLikelihoodScore_02.swedes220"
...
#refFol="finalLikelihoodScore_250k_imputed_cm75"
...
#	cd ${folders[$i]}/bsmap/$refFol
	cd ${folders[$i]}/$refFol
#	Rscript ~/MyScripts/CompareVCFtoDataAcc/12_CompareVCFtoDataAcc/02_makeCSVTable_CompareAccessions.R $ecos $output $acc ${ids[$i]}
	Rscript ~/MyScripts/CompareVCFtoDataAcc/12_CompareVCFtoDataAcc/02_makeCSVTable_fieldExp.R $output ${ids[$i]}
done

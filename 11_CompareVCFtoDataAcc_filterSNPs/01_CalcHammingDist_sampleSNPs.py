...
inOptions.add_option("-s", "--sampleNum", dest="sampleNum", help="Number of SNPs to be randomly selected from all", type="int")
...
filterInd = numpy.sort(random.sample(numpy.array(range(allTargetSNPs.shape[0])), options.sampleNum))

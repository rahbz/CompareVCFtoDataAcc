...
DF <- data.frame(FILENAME = Names, ExpectedParent1 = FouParents1, ExpectedParent2 = FouParents2, Score = ScoreP1, FracEstimate = as.numeric(FracSNPs2), KinEstimate = as.numeric(KinEstimate), SNPsmatchedP1 = as.numeric(SNPsmat1), SNPsmatchedP2 = as.numeric(SNPsmat2), SNPsCalled = SNPsCalled, ThirdHit = FouParents3, FourthHit = FouParents4, FifthHit = FouParents5, SixthHit = FouParents6)

...
inOptions.add_option("-m", "--outMatFile", dest="outMat", help="Output positions for non-matched positions")
inOptions.add_option("-n", "--outNonMatFile", dest="outNonMat", help="Output positions for matched positions")

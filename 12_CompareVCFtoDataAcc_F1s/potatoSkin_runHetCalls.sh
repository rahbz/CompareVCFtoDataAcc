...
#	cd ${folders[$i]}/$refFol
#	Rscript ~/MyScripts/CompareVCFtoDataAcc/11_CompareVCFtoDataAcc/02_makeCSVTable_CompareAccessions.R $ecos $output $acc ${ids[$i]}
#	Rscript ~/MyScripts/CompareVCFtoDataAcc/11_CompareVCFtoDataAcc/02_makeCSVTable_fieldExp.R $output ${ids[$i]}
	bash ~/MyScripts/CompareVCFtoDataAcc/12_CompareVCFtoDataAcc_F1s/02_getHetPercentage.sh 
done
